...
- An extended catalog (“dr14q_spec_prop_ext.fits”) where all the columns of DR14Q (Paris et al. 2018) are appended after the main catalog (i.e., after column # 274). The extended catalog has a total of 380 columns.
